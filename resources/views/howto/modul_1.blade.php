			...
			<div class="panel-container show">
				<div class="panel-content p-0">
					<div class="row no-gutters row-grid">
						<!-- thread -->
						<div class="col-12">
							<object data="{{ asset('docs/howto/modul_1.pdf') }}" type="application/pdf" width="100%" height="800px">
								<p>Maaf, peramban Anda belum terpasang/memiliki plugin untuk menampilkan modul panduan ini. <a href="{{ asset('docs/howto/modul_1.pdf') }}">Silahkan unduh Panduan di</a></p>
							</object>
						</div>
					</div>
				</div>
