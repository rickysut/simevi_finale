    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.provinsis.update", [$provinsi->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kd_dt1') ? 'is-invalid' : '' }}" type="text" name="kd_dt1" id="kd_dt1" value="{{ old('kd_dt1', $provinsi->kd_dt1) }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kd_kemenkeu') ? 'is-invalid' : '' }}" type="text" name="kd_kemenkeu" id="kd_kemenkeu" value="{{ old('kd_kemenkeu', $provinsi->kd_kemenkeu) }}" >
