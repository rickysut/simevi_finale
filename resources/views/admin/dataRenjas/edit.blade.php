...
<div class="card">
    <!--div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dataRenja.title_singular') }}
    </div-->

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-renjas.update", [$dataRenja->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="thang">{{ trans('cruds.dataRenja.fields.thang') }}</label>
                <input class="form-control {{ $errors->has('thang') ? 'is-invalid' : '' }}" type="number" name="thang" id="thang" value="{{ old('thang', $dataRenja->thang) }}" step="1" required>
                @if($errors->has('thang'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdjendok') ? 'is-invalid' : '' }}" type="text" name="kdjendok" id="kdjendok" value="{{ old('kdjendok', $dataRenja->kdjendok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdsatker') ? 'is-invalid' : '' }}" type="text" name="kdsatker" id="kdsatker" value="{{ old('kdsatker', $dataRenja->kdsatker) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kddept') ? 'is-invalid' : '' }}" type="text" name="kddept" id="kddept" value="{{ old('kddept', $dataRenja->kddept) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdunit') ? 'is-invalid' : '' }}" type="text" name="kdunit" id="kdunit" value="{{ old('kdunit', $dataRenja->kdunit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdprogram') ? 'is-invalid' : '' }}" type="text" name="kdprogram" id="kdprogram" value="{{ old('kdprogram', $dataRenja->kdprogram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdgiat') ? 'is-invalid' : '' }}" type="text" name="kdgiat" id="kdgiat" value="{{ old('kdgiat', $dataRenja->kdgiat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdoutput') ? 'is-invalid' : '' }}" type="text" name="kdoutput" id="kdoutput" value="{{ old('kdoutput', $dataRenja->kdoutput) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdlokasi') ? 'is-invalid' : '' }}" type="text" name="kdlokasi" id="kdlokasi" value="{{ old('kdlokasi', $dataRenja->kdlokasi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdkabkota') ? 'is-invalid' : '' }}" type="text" name="kdkabkota" id="kdkabkota" value="{{ old('kdkabkota', $dataRenja->kdkabkota) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kddekon') ? 'is-invalid' : '' }}" type="text" name="kddekon" id="kddekon" value="{{ old('kddekon', $dataRenja->kddekon) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdsoutput') ? 'is-invalid' : '' }}" type="text" name="kdsoutput" id="kdsoutput" value="{{ old('kdsoutput', $dataRenja->kdsoutput) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdkmpnen') ? 'is-invalid' : '' }}" type="text" name="kdkmpnen" id="kdkmpnen" value="{{ old('kdkmpnen', $dataRenja->kdkmpnen) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdskmpnen') ? 'is-invalid' : '' }}" type="text" name="kdskmpnen" id="kdskmpnen" value="{{ old('kdskmpnen', $dataRenja->kdskmpnen) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdakun') ? 'is-invalid' : '' }}" type="text" name="kdakun" id="kdakun" value="{{ old('kdakun', $dataRenja->kdakun) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdkppn') ? 'is-invalid' : '' }}" type="text" name="kdkppn" id="kdkppn" value="{{ old('kdkppn', $dataRenja->kdkppn) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdbeban') ? 'is-invalid' : '' }}" type="text" name="kdbeban" id="kdbeban" value="{{ old('kdbeban', $dataRenja->kdbeban) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdjnsban') ? 'is-invalid' : '' }}" type="text" name="kdjnsban" id="kdjnsban" value="{{ old('kdjnsban', $dataRenja->kdjnsban) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdctarik') ? 'is-invalid' : '' }}" type="text" name="kdctarik" id="kdctarik" value="{{ old('kdctarik', $dataRenja->kdctarik) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('register') ? 'is-invalid' : '' }}" type="text" name="register" id="register" value="{{ old('register', $dataRenja->register) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carahitung') ? 'is-invalid' : '' }}" type="text" name="carahitung" id="carahitung" value="{{ old('carahitung', $dataRenja->carahitung) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('header1') ? 'is-invalid' : '' }}" type="text" name="header1" id="header1" value="{{ old('header1', $dataRenja->header1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('header2') ? 'is-invalid' : '' }}" type="text" name="header2" id="header2" value="{{ old('header2', $dataRenja->header2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdheader') ? 'is-invalid' : '' }}" type="text" name="kdheader" id="kdheader" value="{{ old('kdheader', $dataRenja->kdheader) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('noitem') ? 'is-invalid' : '' }}" type="number" name="noitem" id="noitem" value="{{ old('noitem', $dataRenja->noitem) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nmitem') ? 'is-invalid' : '' }}" type="text" name="nmitem" id="nmitem" value="{{ old('nmitem', $dataRenja->nmitem) }}">
                @if($errors->has('nmitem'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nmitem') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.dataRenja.fields.nmitemhelper') }}</span>
            </div>
            <div class="form-group">
                <label for="vol1">{{ trans('cruds.dataRenja.fields.vol1') }}</label>
                <input class="form-control {{ $errors->has('vol1') ? 'is-invalid' : '' }}" type="number" name="vol1" id="vol1" value="{{ old('vol1', $dataRenja->vol1) }}" step="0.01">
                @if($errors->has('vol1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vol1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sat1') ? 'is-invalid' : '' }}" type="text" name="sat1" id="sat1" value="{{ old('sat1', $dataRenja->sat1) }}">
                @if($errors->has('sat1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sat1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vol2') ? 'is-invalid' : '' }}" type="number" name="vol2" id="vol2" value="{{ old('vol2', $dataRenja->vol2) }}" step="0.01">
                @if($errors->has('vol2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vol2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sat2') ? 'is-invalid' : '' }}" type="text" name="sat2" id="sat2" value="{{ old('sat2', $dataRenja->sat2) }}">
                @if($errors->has('sat2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sat2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vol3') ? 'is-invalid' : '' }}" type="number" name="vol3" id="vol3" value="{{ old('vol3', $dataRenja->vol3) }}" step="0.01">
                @if($errors->has('vol3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vol3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sat3') ? 'is-invalid' : '' }}" type="text" name="sat3" id="sat3" value="{{ old('sat3', $dataRenja->sat3) }}">
                @if($errors->has('sat3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sat3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vol4') ? 'is-invalid' : '' }}" type="number" name="vol4" id="vol4" value="{{ old('vol4', $dataRenja->vol4) }}" step="0.01">
                @if($errors->has('vol4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vol4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sat4') ? 'is-invalid' : '' }}" type="text" name="sat4" id="sat4" value="{{ old('sat4', $dataRenja->sat4) }}">
                @if($errors->has('sat4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sat4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('volkeg') ? 'is-invalid' : '' }}" type="number" name="volkeg" id="volkeg" value="{{ old('volkeg', $dataRenja->volkeg) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satkeg') ? 'is-invalid' : '' }}" type="text" name="satkeg" id="satkeg" value="{{ old('satkeg', $dataRenja->satkeg) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hargasat') ? 'is-invalid' : '' }}" type="number" name="hargasat" id="hargasat" value="{{ old('hargasat', $dataRenja->hargasat) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah') ? 'is-invalid' : '' }}" type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $dataRenja->jumlah) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah2') ? 'is-invalid' : '' }}" type="number" name="jumlah2" id="jumlah2" value="{{ old('jumlah2', $dataRenja->jumlah2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paguphln') ? 'is-invalid' : '' }}" type="text" name="paguphln" id="paguphln" value="{{ old('paguphln', $dataRenja->paguphln) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pagurmp') ? 'is-invalid' : '' }}" type="text" name="pagurmp" id="pagurmp" value="{{ old('pagurmp', $dataRenja->pagurmp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pagurkp') ? 'is-invalid' : '' }}" type="text" name="pagurkp" id="pagurkp" value="{{ old('pagurkp', $dataRenja->pagurkp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdblokir') ? 'is-invalid' : '' }}" type="text" name="kdblokir" id="kdblokir" value="{{ old('kdblokir', $dataRenja->kdblokir) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blokirphln') ? 'is-invalid' : '' }}" type="text" name="blokirphln" id="blokirphln" value="{{ old('blokirphln', $dataRenja->blokirphln) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blokirrmp') ? 'is-invalid' : '' }}" type="text" name="blokirrmp" id="blokirrmp" value="{{ old('blokirrmp', $dataRenja->blokirrmp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blokirrkp') ? 'is-invalid' : '' }}" type="text" name="blokirrkp" id="blokirrkp" value="{{ old('blokirrkp', $dataRenja->blokirrkp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rphblokir') ? 'is-invalid' : '' }}" type="text" name="rphblokir" id="rphblokir" value="{{ old('rphblokir', $dataRenja->rphblokir) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdcopy') ? 'is-invalid' : '' }}" type="text" name="kdcopy" id="kdcopy" value="{{ old('kdcopy', $dataRenja->kdcopy) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdabt') ? 'is-invalid' : '' }}" type="text" name="kdabt" id="kdabt" value="{{ old('kdabt', $dataRenja->kdabt) }}">
                @if($errors->has('kdabt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kdabt') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdsbu') ? 'is-invalid' : '' }}" type="text" name="kdsbu" id="kdsbu" value="{{ old('kdsbu', $dataRenja->kdsbu) }}">
                @if($errors->has('kdsbu'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kdsbu') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('volsbk') ? 'is-invalid' : '' }}" type="number" name="volsbk" id="volsbk" value="{{ old('volsbk', $dataRenja->volsbk) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('volrkakl') ? 'is-invalid' : '' }}" type="number" name="volrkakl" id="volrkakl" value="{{ old('volrkakl', $dataRenja->volrkakl) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blnkontrak') ? 'is-invalid' : '' }}" type="text" name="blnkontrak" id="blnkontrak" value="{{ old('blnkontrak', $dataRenja->blnkontrak) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nokontrak') ? 'is-invalid' : '' }}" type="text" name="nokontrak" id="nokontrak" value="{{ old('nokontrak', $dataRenja->nokontrak) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tgkontrak') ? 'is-invalid' : '' }}" type="text" name="tgkontrak" id="tgkontrak" value="{{ old('tgkontrak', $dataRenja->tgkontrak) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilkontrak') ? 'is-invalid' : '' }}" type="text" name="nilkontrak" id="nilkontrak" value="{{ old('nilkontrak', $dataRenja->nilkontrak) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('januari') ? 'is-invalid' : '' }}" type="text" name="januari" id="januari" value="{{ old('januari', $dataRenja->januari) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pebruari') ? 'is-invalid' : '' }}" type="text" name="pebruari" id="pebruari" value="{{ old('pebruari', $dataRenja->pebruari) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maret') ? 'is-invalid' : '' }}" type="text" name="maret" id="maret" value="{{ old('maret', $dataRenja->maret) }}">
                @if($errors->has('maret'))
                    <div class="invalid-feedback">
                        {{ $errors->first('maret') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('april') ? 'is-invalid' : '' }}" type="text" name="april" id="april" value="{{ old('april', $dataRenja->april) }}">
                @if($errors->has('april'))
                    <div class="invalid-feedback">
                        {{ $errors->first('april') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mei') ? 'is-invalid' : '' }}" type="text" name="mei" id="mei" value="{{ old('mei', $dataRenja->mei) }}">
                @if($errors->has('mei'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mei') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('juni') ? 'is-invalid' : '' }}" type="text" name="juni" id="juni" value="{{ old('juni', $dataRenja->juni) }}">
                @if($errors->has('juni'))
                    <div class="invalid-feedback">
                        {{ $errors->first('juni') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('juli') ? 'is-invalid' : '' }}" type="text" name="juli" id="juli" value="{{ old('juli', $dataRenja->juli) }}">
                @if($errors->has('juli'))
                    <div class="invalid-feedback">
                        {{ $errors->first('juli') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agustus') ? 'is-invalid' : '' }}" type="text" name="agustus" id="agustus" value="{{ old('agustus', $dataRenja->agustus) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('september') ? 'is-invalid' : '' }}" type="text" name="september" id="september" value="{{ old('september', $dataRenja->september) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oktober') ? 'is-invalid' : '' }}" type="text" name="oktober" id="oktober" value="{{ old('oktober', $dataRenja->oktober) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nopember') ? 'is-invalid' : '' }}" type="text" name="nopember" id="nopember" value="{{ old('nopember', $dataRenja->nopember) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desember') ? 'is-invalid' : '' }}" type="text" name="desember" id="desember" value="{{ old('desember', $dataRenja->desember) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jmltunda') ? 'is-invalid' : '' }}" type="text" name="jmltunda" id="jmltunda" value="{{ old('jmltunda', $dataRenja->jmltunda) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdluncuran') ? 'is-invalid' : '' }}" type="text" name="kdluncuran" id="kdluncuran" value="{{ old('kdluncuran', $dataRenja->kdluncuran) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jmlabt') ? 'is-invalid' : '' }}" type="text" name="jmlabt" id="jmlabt" value="{{ old('jmlabt', $dataRenja->jmlabt) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('norev') ? 'is-invalid' : '' }}" type="text" name="norev" id="norev" value="{{ old('norev', $dataRenja->norev) }}">
                @if($errors->has('norev'))
                    <div class="invalid-feedback">
                        {{ $errors->first('norev') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdubah') ? 'is-invalid' : '' }}" type="text" name="kdubah" id="kdubah" value="{{ old('kdubah', $dataRenja->kdubah) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kurs') ? 'is-invalid' : '' }}" type="number" name="kurs" id="kurs" value="{{ old('kurs', $dataRenja->kurs) }}" step="0.01">
                @if($errors->has('kurs'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kurs') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indexkpjm') ? 'is-invalid' : '' }}" type="number" name="indexkpjm" id="indexkpjm" value="{{ old('indexkpjm', $dataRenja->indexkpjm) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdib') ? 'is-invalid' : '' }}" type="text" name="kdib" id="kdib" value="{{ old('kdib', $dataRenja->kdib) }}">
                @if($errors->has('kdib'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kdib') }}
                    </div>
