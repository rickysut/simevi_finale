    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-realisasis.update", [$dataRealisasi->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tahun') ? 'is-invalid' : '' }}" type="text" name="tahun" id="tahun" value="{{ old('tahun', $dataRealisasi->tahun) }}" required>
                @if($errors->has('tahun'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdsatker') ? 'is-invalid' : '' }}" type="text" name="kdsatker" id="kdsatker" value="{{ old('kdsatker', $dataRealisasi->kdsatker) }}" >
