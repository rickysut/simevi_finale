...
<div class="card">
    <!--div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.masterKegiatan.title_singular') }}
    </div-->

    <div class="card-body">
        <form method="POST" action="{{ route("admin.master-kegiatans.update", [$masterKegiatan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="kddept">{{ trans('cruds.masterKegiatan.fields.kddept') }}</label>
                <input class="form-control {{ $errors->has('kddept') ? 'is-invalid' : '' }}" type="text" name="kddept" id="kddept" value="{{ old('kddept', $masterKegiatan->kddept) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdunit') ? 'is-invalid' : '' }}" type="text" name="kdunit" id="kdunit" value="{{ old('kdunit', $masterKegiatan->kdunit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kd_kegiatan') ? 'is-invalid' : '' }}" type="text" name="kd_kegiatan" id="kd_kegiatan" value="{{ old('kd_kegiatan', $masterKegiatan->kd_kegiatan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direktorat') ? 'is-invalid' : '' }}" type="text" name="direktorat" id="direktorat" value="{{ old('direktorat', $masterKegiatan->direktorat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomenklatur_giat') ? 'is-invalid' : '' }}" type="text" name="nomenklatur_giat" id="nomenklatur_giat" value="{{ old('nomenklatur_giat', $masterKegiatan->nomenklatur_giat) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\MasterKegiatan::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $masterKegiatan->status) === (int) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
