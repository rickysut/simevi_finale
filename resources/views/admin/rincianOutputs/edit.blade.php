...
<div class="card">
    <!--div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.rincianOutput.title_singular') }}
    </div-->

    <div class="card-body">
        <form method="POST" action="{{ route("admin.rincian-outputs.update", [$rincianOutput->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="idoutp">{{ trans('cruds.rincianOutput.fields.idoutp') }}</label>
                <input class="form-control {{ $errors->has('idoutp') ? 'is-invalid' : '' }}" type="text" name="idoutp" id="idoutp" value="{{ old('idoutp', $rincianOutput->idoutp) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('idoutp_1') ? 'is-invalid' : '' }}" type="text" name="idoutp_1" id="idoutp_1" value="{{ old('idoutp_1', $rincianOutput->idoutp_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdgiat') ? 'is-invalid' : '' }}" type="text" name="kdgiat" id="kdgiat" value="{{ old('kdgiat', $rincianOutput->kdgiat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdoutput') ? 'is-invalid' : '' }}" type="text" name="kdoutput" id="kdoutput" value="{{ old('kdoutput', $rincianOutput->kdoutput) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nmoutput') ? 'is-invalid' : '' }}" type="text" name="nmoutput" id="nmoutput" value="{{ old('nmoutput', $rincianOutput->nmoutput) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sat') ? 'is-invalid' : '' }}" type="text" name="sat" id="sat" value="{{ old('sat', $rincianOutput->sat) }}">
                @if($errors->has('sat'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sat') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdsum') ? 'is-invalid' : '' }}" type="text" name="kdsum" id="kdsum" value="{{ old('kdsum', $rincianOutput->kdsum) }}">
                @if($errors->has('kdsum'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kdsum') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thnawal') ? 'is-invalid' : '' }}" type="number" name="thnawal" id="thnawal" value="{{ old('thnawal', $rincianOutput->thnawal) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thnakhir') ? 'is-invalid' : '' }}" type="number" name="thnakhir" id="thnakhir" value="{{ old('thnakhir', $rincianOutput->thnakhir) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdmulti') ? 'is-invalid' : '' }}" type="number" name="kdmulti" id="kdmulti" value="{{ old('kdmulti', $rincianOutput->kdmulti) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdjnsout') ? 'is-invalid' : '' }}" type="number" name="kdjnsout" id="kdjnsout" value="{{ old('kdjnsout', $rincianOutput->kdjnsout) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdikk') ? 'is-invalid' : '' }}" type="number" name="kdikk" id="kdikk" value="{{ old('kdikk', $rincianOutput->kdikk) }}" step="1">
                @if($errors->has('kdikk'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kdikk') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdtema') ? 'is-invalid' : '' }}" type="number" name="kdtema" id="kdtema" value="{{ old('kdtema', $rincianOutput->kdtema) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdcttout') ? 'is-invalid' : '' }}" type="number" name="kdcttout" id="kdcttout" value="{{ old('kdcttout', $rincianOutput->kdcttout) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thang') ? 'is-invalid' : '' }}" type="number" name="thang" id="thang" value="{{ old('thang', $rincianOutput->thang) }}" step="1">
                @if($errors->has('thang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('thang') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdpn') ? 'is-invalid' : '' }}" type="number" name="kdpn" id="kdpn" value="{{ old('kdpn', $rincianOutput->kdpn) }}" step="1">
                @if($errors->has('kdpn'))
                    <div class="invalid-feedback">
                        {{ $errors->first('kdpn') }}
                    </div>
